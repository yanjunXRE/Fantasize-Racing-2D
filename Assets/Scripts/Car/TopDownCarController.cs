...
public class TopDownCarController : MonoBehaviour
{
    ...
    public float accelerationFactor = 30.0f;//Set how fast should the car accelerate 
    public float turnFactor = 3.5f;//Set how fast should the car turn
    public float maxSpeed = 20;//Set the max speed of the car
    ...
    float rotationAngle = 0;//rotationAngle is needed to know how to rotate the car
    ...
    //Components
    Rigidbody2D carRigidbody2D;/*In physics, a rigid body is a solid body
     in which deformation is zero  or so small it can be neglected. 
    ...
    Collider2D carCollider;/*Collider components define the shape of an object
     for the purposes of physical collisions. A collider is responsible for detecting when an object
      collides with another object.A collider basically defines a shape in space. If object A’s collider 
      intersects object B’s collider, then the objects are said to have collided. */
